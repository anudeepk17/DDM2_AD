...
class MRIDataset(Dataset):
    def __init__(self, dataroot, valid_mask, phase='train', image_size=320, in_channel=1, val_volume_idx=50, val_slice_idx=40,
        ...
        # normalize data
        raw_data = raw_data.astype(np.float32) / np.max(raw_data.astype(np.float32), axis=(0,1,2), keepdims=True)
