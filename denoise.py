...
if __name__ == "__main__":
    ...
    parser.add_argument('-c', '--config', type=str, default='/srv/home/kumar256/DDM2/DDM2/config/s3sh.json',
    ...
    for step,  val_data in enumerate(val_loader):
        ...
        if not args.save:
            ...
            denoised_img = Metrics.tensor2img(visuals['denoised'], out_type=np.float) # w, h, 1 
